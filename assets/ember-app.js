...
define('ember-app/locales/en/models/i-i-s-trtr-gfdg', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/models/i-i-s-trtr-gfdg'], function (exports, _translations, _iISTrtrGfdg) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-trtr-gfdg': _iISTrtrGfdg.default
    },
...
define('ember-app/locales/ru/models/i-i-s-trtr-gfdg', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/models/i-i-s-trtr-gfdg'], function (exports, _translations, _iISTrtrGfdg) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-trtr-gfdg', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-trtr-gfdg-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-trtr-gfdg', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-trtr-gfdg', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-trtr-gfdg'], function (exports, _emberCpValidations, _model, _iISTrtrGfdg) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISTrtrGfdg.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISTrtrGfdg.Model, Validations, {});
...
define('ember-app/serializers/i-i-s-trtr-gfdg-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-trtr-gfdg-offline', 'ember-app/serializers/application-offline'], function (exports, _iISTrtrGfdgOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISTrtrGfdgOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-trtr-gfdg', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-trtr-gfdg', 'ember-app/serializers/application'], function (exports, _iISTrtrGfdg, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISTrtrGfdg.Serializer, {
    /**
